...
class TrendingPage extends React.Component {
  ...
  _loadData = () =>  {
    ...
    trendingAction.onLoadData(tabBarLabel, searchValue);
  }
    ...
    return (
      <TrendingItem
        ...
        onSelect={() => {
          ...
          NavigationUtil.goPage('DetailPage', item);
        }}
        // == 添加/取消收藏
        onFavorite={ (item, isFavorite) => {
          FavoriteUtil.onFavorite('trending', isFavorite, item.fullName.toString(), JSON.stringify(item));
        }}
      />
    );
  }
