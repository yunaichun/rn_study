...
export default (state = initialState, action) => {
  switch(action.type)  {
    ...
    case TRPES.SEARCH_REFRESH_SUCCESS:
        return {
            ...state,
            firstRequest: false,
            isLoading: false,
    ...
    case TRPES.SEARCH_CANCEL:
    case TRPES.SEARCH_REFRESH_FAIL:
        return {
            ...state,
            firstRequest: false,
            isLoading: false,
    ...
    case TRPES.SEARCH_LOAD_MORE:
            return {
                ...state,
                isLoading: true
            }
    case TRPES.SEARCH_LOAD_MORE_SUCCESS:
